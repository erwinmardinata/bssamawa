		...
		<!-- form start -->
		  <div class="box-body">
			...
			<div class="form-group">
			  ...
			  <input type="date" name="tanggal_daftar" class="form-control" value="<?php echo date("Y-m-d"); ?>">
			</div>
			<div class="form-group">
			  <label for="exampleInputPassword1">No. Rekening</label>
			  <input type="text" name="no_rekening" class="form-control" value="<?php echo $norek; ?>">
			</div>
			<div class="form-group">
